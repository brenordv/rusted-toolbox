...
# 5. Exclude the ported Unix tools (cat, head, tail, touch) to avoid shadowing coreutils
#
# Notes:
...
install_tools() {
  ...
  # coreutils already provides. The same ported list lives in build.sh and release.yml.
