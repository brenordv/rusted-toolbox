...
mod tests {
    ...
    #[test]
    fn validate_accepts_single_generation_defaults() {
        let args = GuidArgs {
            add_to_clipboard: false,
            generate_empty_guid: false,
            silent: false,
            generate_on_interval: None,
        };
    ...
    #[test]
    fn validate_accepts_clipboard_and_empty_without_interval() {
        let args = GuidArgs {
            add_to_clipboard: true,
            generate_empty_guid: true,
            silent: true,
            generate_on_interval: None,
        };
