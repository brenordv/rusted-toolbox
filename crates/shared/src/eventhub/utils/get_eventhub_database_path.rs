use crate::eventhub::utils::extract_eventhub_endpoint_from_connection_string::extract_eventhub_endpoint_from_connection_string;
use crate::system::resolve_path_with_base::resolve_path_with_base;
