...
pub fn generate_email(_options: &MockOptions) -> Result<String> {
    ...
    let domains = ["gmail.com", "yahoo.com", "hotmail.com", "outlook.com", "example.com"];
...
pub fn generate_address(_options: &MockOptions) -> Result<String> {
    ...
    Ok(format!("{} {}, {}, {} {}", street_number, street_name, city, state, zip))
}
...
pub fn generate_birthday(options: &MockOptions) -> Result<String> {
    ...
    let age = options.age.unwrap_or_else(|| rand::thread_rng().gen_range(18..80));
    ...
    let day = match month {
        2 => {
            ...
            if is_leap { rand::thread_rng().gen_range(1..=29) } else { rand::thread_rng().gen_range(1..=28) }
        },
