use crate::message_builders::system_message_builders::build_rust_ai_function_system_message;
use crate::models::file_process_item_model::FileProcessItem;
use crate::models::file_process_item_traits::FileProcessItemTraits;
use crate::models::models::FileProcessResult::{
